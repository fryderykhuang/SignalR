...
namespace Owin
{
    ...
    public static class OwinExtensions
    {
        ...
        public static IApplicationBuilder MapSignalR(this IApplicationBuilder builder)
        {
        ...
        public static IApplicationBuilder MapSignalR(this IApplicationBuilder builder, HubConfiguration configuration)
        {
        ...
        /// <param name="configuration">The <see cref="HubConfiguration"/> to use</param>
        public static IApplicationBuilder MapSignalR(this IApplicationBuilder builder, string path, HubConfiguration configuration)
        {
        ...
        /// <param name="builder">The app builder</param>
        /// <param name="configuration">The <see cref="HubConfiguration"/> to use</param>
        public static void RunSignalR(this IApplicationBuilder builder, HubConfiguration configuration)
        {
        ...
        public static IApplicationBuilder MapSignalR<TConnection>(this IApplicationBuilder builder, string path) where TConnection : PersistentConnection
        {
        ...
        /// <returns></returns>
        [SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Justification = "The type parameter is syntactic sugar")]
        public static IApplicationBuilder MapSignalR<TConnection>(this IApplicationBuilder builder, string path, ConnectionConfiguration configuration) where TConnection : PersistentConnection
        {
        ...
        /// <param name="configuration">The <see cref="ConnectionConfiguration"/> to use</param>
        public static IApplicationBuilder MapSignalR(this IApplicationBuilder builder, string path, Type connectionType, ConnectionConfiguration configuration)
        {
            if (configuration == null)
            {
                throw new ArgumentNullException("configuration");
        ...
        /// <returns></returns>
        [SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Justification = "The type parameter is syntactic sugar")]
        public static void RunSignalR<TConnection>(this IApplicationBuilder builder, ConnectionConfiguration configuration) where TConnection : PersistentConnection
        {
        ...
        /// <param name="configuration">The <see cref="ConnectionConfiguration"/> to use</param>
        /// <returns></returns>
        public static void RunSignalR(this IApplicationBuilder builder, Type connectionType, ConnectionConfiguration configuration)
        {
        ...
        private static IApplicationBuilder UseSignalRMiddleware<T>(this IApplicationBuilder builder, params object[] args)
        {
            EnsureValidCulture();
...
// TODO           SignatureConversions.AddConversions(builder);
            ...
            if (args.Length > 0)
            {
                ...
                // Dpapi provider
                IDataProtectionProvider provider = builder.ApplicationServices.GetDataProtectionProvider();
...
//                        provider = new DpapiDataProtectionProvider(instanceName);
            ...
            builder.UseMiddleware(typeof(T), args);
...
// TODO            builder.UseStageMarker(PipelineStage.PostAuthorize);
