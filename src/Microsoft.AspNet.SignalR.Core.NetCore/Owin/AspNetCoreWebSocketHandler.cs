...
namespace Microsoft.AspNet.SignalR.Owin
{
    ...
    internal class AspNetCoreWebSocketHandler
    {
        ...
        public AspNetCoreWebSocketHandler(Func<IWebSocket, Task> callback, Action<IWebSocket> prepareWebsocket, int? maxIncomingMessageSize)
        {
            _callback = callback;
        ...
        public Task ProcessRequest(WebSocket webSocket, HttpContext context)
        {
