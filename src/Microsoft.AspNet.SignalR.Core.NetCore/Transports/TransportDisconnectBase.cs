...
namespace Microsoft.AspNet.SignalR.Transports
{
    ...
    public abstract class TransportDisconnectBase : ITrackingConnection
    {
        ...
        {
            return TaskAsyncHelper.FromResult((string) Context.Request.Query["groupsToken"]);
        }
        ...
        protected bool IsConnectRequest
        {
            get
            {
                return Context.Request.Path.Value.EndsWith("/connect", StringComparison.OrdinalIgnoreCase);
            }
        }
        ...
        protected bool IsSendRequest
        {
            get
            {
                return Context.Request.Path.Value.EndsWith("/send", StringComparison.OrdinalIgnoreCase);
            }
        }
        ...
        protected bool IsAbortRequest
        {
            get
            {
                return Context.Request.Path.Value.EndsWith("/abort", StringComparison.OrdinalIgnoreCase);
            }
        }
...
//        }
        ...
        {
            _hostShutdownToken = CancellationToken.None; // TODO _context.Environment.GetShutdownToken();
