...
namespace Microsoft.AspNet.SignalR.Transports
{
    ...
    public abstract class ForeverTransport : TransportDisconnectBase, ITransport
    {
        ...
        protected ForeverTransport(HttpContext context, IDependencyResolver resolver)
            : this(context,
        ...
        protected virtual async Task ProcessSendRequest()
        {
            Context.Request.ContentType =
                Context.Request.ContentType.Replace("text/plain", "application/x-www-form-urlencoded");
