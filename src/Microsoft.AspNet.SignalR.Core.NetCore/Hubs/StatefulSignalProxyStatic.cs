...
{
    public class StatefulSignalProxyStatic : SignalProxyStatic
    {
        private readonly StateChangeTracker _tracker;

        public StatefulSignalProxyStatic(IConnection connection, IHubPipelineInvoker invoker, string signal, string hubName, string prefix, StateChangeTracker tracker)
