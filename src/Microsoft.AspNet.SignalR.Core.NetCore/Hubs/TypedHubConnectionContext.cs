...
namespace Microsoft.AspNet.SignalR.Hubs
{
    public class TypedHubConnectionContext<T> : IHubConnectionContext<T>
    {
        ...
        public UserProxyStatic UserStatic(string userId)
        {
            return _dynamicContext.UserStatic(userId);
        }
        ...
        public MultipleSignalProxyStatic UsersStatic(IList<string> userIds)
        {
            return _dynamicContext.UsersStatic(userIds);
        }
    }
}
